    ...
    return (
        <div className="flex  justify-center items-center mb-72 px-10 sm:px-0">
            ...
            <div className="flex flex-col w-[1000px]">
                ...
                <Title title="Verify Order" subtitle="Please review your order" />

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">

                    <div className="flex flex-col mt-5">                        
                        <Link href="/cart" className="flex items-center gap-2 underline mb-5">
                    ...
                    <div className=" bg-white rounded-xl shadow-xl p-7">
                        ...
                        <div className="mt-5 mb-2 w-full">
                            <Link href="/orders/123" className="flex justify-center btn-primary ">Create Order</Link>
                        </div>
                    </div>
