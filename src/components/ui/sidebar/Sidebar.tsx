   ...
   const closeSideMenu = useUiStore((state) => state.closeSideMenu);
    ...
    return (
        <div>
            ...
            {isSideMenuOpen && (
                <div onClick={closeSideMenu} className ="fixed top-0 left-0 w-screen h-screen z-10 bg-black opacity-30" /> 
            )}
            ...
            <nav className ={
                ...
                <div className ="relative mt-14">
                    ...
                    <input 
                        type="text"
                        placeholder="Search"
                        className="w-full bg-gray-50 rounded pl-10 py-1 pr-10 border-b-2 text-xt border-gray-200 focus:outline-none focus:border-blue-500"
                    />
                </div>  
